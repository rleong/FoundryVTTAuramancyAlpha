export default class ActorMovementConfig extends DocumentSheet {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["auramancy"],
      template: "systems/auramancy/templates/apps/movement-config.html",
      width: 300,
      height: "auto"
    });
  }
  ...
  /** @inheritdoc */
  getData(options) {
    const movement = foundry.utils.getProperty(this.document.data._source, "data.traveling.movement_options") || {};
    const data = {
      movement: {},
